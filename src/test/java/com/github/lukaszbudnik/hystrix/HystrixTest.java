...
import com.github.lukaszbudnik.hystrix.core.FullyParallelCompletableFutureDedicatedExecutorHystrixBlogGuiceModule;
...
public class HystrixTest {
    ...
    public void s6SaveFullyParallelCompletableFutureDedicatedExecutorBlog() throws Exception {
        ...
        ConfigurationManager.getConfigInstance().setProperty("hystrix.command.default.execution.isolation.thread.timeoutInMilliseconds", 30 * 1000);
